...
$update = $_GET['update'];
$sql = "select * from users where username='$update'";
...
if (isset($_POST['submit'])) {
  ...
  $sql = "update personal_info set username='$update',email='$email'
        ...
        <div class="container">
          <form method="post" class="my-5">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" placeholder="" name="username" autocomplete="off" value=<?php echo $username ?>>
            </div>
            <div class="mb-3">
              <label class="form-label">email</label>
              <input type="text" class="form-control" placeholder="" name="email" autocomplete="off" value=<?php echo $email ?>>
            </div>
            <!-- <div class="mb-3">
              <label class="form-label">Age</label>
              <input type="number" class="form-control" placeholder="Enter age" name="age" autocomplete="off" value=<?php echo $age ?>>
            </div>
