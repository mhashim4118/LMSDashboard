...
$update = $_GET['update'];
$sql = "select * from personal_info where username='$update'";
...
if (isset($_POST['submit'])) {
  ...
  $sql = "update personal_info set username='$update', id='$ID',name='$name',phone='$phone',address='$address'
  ...
  <div class="container">
    <form method="post" class="my-5">
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control" placeholder="Enter phone no" name="phone" autocomplete="off" value=<?php echo $phone ?>>
      </div>
