...
if (isset($_POST['submit'])) {
    ...
    $sql = " INSERT into personal_info (id, username, role, name, phone, age, department, address, gender)
        values('$ID','$username','$role','$name','$phone','$age','$department','$address','$gender')";
    $result = mysqli_query($connect, $sql);

    if ($result) {
        header('location:/LMSDashboard/Admin/teacherinfo.php');
    } else {
                ...
                <div class="container">
                    <form method="post" class="my-5">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Enter role" name="role" autocomplete="off">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" placeholder="Enter phone no" name="phone" autocomplete="off">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Age</label>
                            <input type="number" class="form-control" placeholder="Enter age" name="age" autocomplete="off">
                        </div>
                        <div class="mb-3">
