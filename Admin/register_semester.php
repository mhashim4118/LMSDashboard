...
if (isset($_POST['submit'])) {
    ...
    $sql = " INSERT into register_semester (SemesterName,Year)
        values('$name', '$year')";
    $result = mysqli_query($connect, $sql);

    if ($result) {
        header('location:/LMSDashboard/Admin/register_semester.php');
    } else {
        die(mysqli_error($connect));
    }
}
$squery = "SELECT concat(SemesterName,\"-\",Year) as Semester from register_semester;";
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row mt-5">
                    <div>
                                <a style="float:right" class="btn btn-success mb-2" href="/LMSDashboard/Admin/course_registration.php"><i class="fa fa-hand-point-left">Back</i></a>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="mb-3">
                                        ...
                                        <select required name="SemesterName" class="form-select" aria-label="Default select example">
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        ...
                                        <input required type="number" class="form-control" placeholder="Year" name="Year" autocomplete="off">
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <div class="card mt-5">
                                <div class="card-header">
                                    <h2 class="display-8 text-center font-weight-bolder">Semester Details</h2>
                                </div>
                                <div class="card-body">
