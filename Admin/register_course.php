...
if (isset($_POST['submit'])) {
    ...
    $sql = " INSERT into register_course (Code, Name)
        values('$code','$coursename's)";
    $result = mysqli_query($connect, $sql);

    if ($result) {
        header('location:/LMSDashboard/Admin/course_registration.php');
    } else {
                ...
                <div class="container">
                    <form method="post" class="my-5">
                        ...
                        <!-- <div class="mb-3">
                            ...
                            <select name="SemesterName" class="form-select" aria-label="Default select example">
                        ...
                        <!-- <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Instructor Name" name="iname" autocomplete="off">
                        </div> -->
                        <!-- <div class="mb-3">
                            <label class="form-label">Semester</label>
                            <input type="text" class="form-control" placeholder="Enter Semester Name" name="semester" autocomplete="off">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Year</label>
                            <input type="text" class="form-control" placeholder="Enter Semester Year" name="Year" autocomplete="off">
                        </div> -->
