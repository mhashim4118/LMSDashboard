...
$tquery = "SELECT * from personal_info where role='teacher';";
                        ...
                        <div class="col">
                            <div class="card mt-5">
                                <div class="card-header">
                                    <h2 class="display-8 text-center font-weight-bolder">Teacher Table<a href="/LMSDashboard/Admin/create_teacher.php"><button class="btn btn-info mt-2">Add Teacher</button></a></h2>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered text-center">
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                    ...
                                                    <td><a href="/LMSDashboard/Admin/edit_teacher.php?update=<?php echo $row['username'] ?>"><i class="fa fa-edit"></i>Edit</a></td>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="/LMSDashboard/Admin/delete_teacher.php?deleteusername=<?php echo $row['username'] ?>"><button type="button" class="btn btn-danger">Yes</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
